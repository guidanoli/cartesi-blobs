...
const config: HardhatUserConfig = {
    ...
    external: {
        ...
        deployments: {
            ...
            arbitrum: [
                ppath("@cartesi/util", "/deployments/arbitrum"),
                ppath("@cartesi/rollups", "/deployments/arbitrum"),
            ],
            arbitrum_sepolia: [
                ppath("@cartesi/util", "/deployments/arbitrum_sepolia"),
                ppath("@cartesi/rollups", "/deployments/arbitrum_sepolia"),
            ],
            mainnet: [
                ppath("@cartesi/util", "/deployments/mainnet"),
                ppath("@cartesi/rollups", "/deployments/mainnet"),
            ],
            optimism: [
                ppath("@cartesi/util", "/deployments/optimism"),
                ppath("@cartesi/rollups", "/deployments/optimism"),
            ],
            optimism_sepolia: [
                ppath("@cartesi/util", "/deployments/optimism_sepolia"),
                ppath("@cartesi/rollups", "/deployments/optimism_sepolia"),
            ],
            sepolia: [
